$(document).ready(function() {
    ...
    // Games Collapse Button
    $(".games-collapse-btn").click(function() {
        $(this).addClass('hide-element');
        $($(this).attr('data-toshow')).removeClass('hide-element');
    });

    // Navbar Resize Function
    $(window).scroll(function() {
        var value = $(this).scrollTop();
        if (value > $(window).height() * 0.5)
    ...
    function submitForm() {
        ...
        $.ajax({
            type: "POST",
            url: "https://cwzgiskf51.execute-api.us-east-1.amazonaws.com/prod/contact-us",
            dataType: "json",
            crossDomain: "true",
